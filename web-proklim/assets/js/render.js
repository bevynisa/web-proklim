      ...
      return (
        '<div class="rencana-item efek-sorot">' +
          ...
          (i.target || i.pj
            ...
            : "") +
          (lampiran.length
            ? '<div class="rencana-lampiran">' +
                '<span class="rencana-lampiran-label">Lampiran Dokumen</span>' +
                lampiran.map(function (l) {
                  return '<a class="rencana-lampiran-tautan" href="' + esc(l.url) + '" target="_blank" rel="noopener">' +
                    '<span class="rencana-lampiran-ikon">' + IKON_PDF_SVG + "</span>" +
                    '<span class="rencana-lampiran-nama">' + esc(l.label) + "</span>" +
                    '<span class="rencana-lampiran-panah">↗</span>' +
                  "</a>";
                }).join("") +
              "</div>"
            : "") +
